<script lang="ts">
	...
	const cardBacks: Record<string, string> = {
		'arcangel-rafael': '/cards/arcangel-rafael-reverso.png',
		'arcangel-gabriel': '/cards/arcangel-gabriel-reverso.png',
		'arcangel-miguel': '/cards/arcangel-miguel-reverso.png',
		'arcangel-uriel': '/cards/arcangel-uriel-reverso-2.png',
	...
	function backImageFor(item: (typeof items)[number] | undefined) {
		...
		if (slug) {
			...
			if (cardBacks[slug]) return cardBacks[slug];
			return `/cards/${slug}-reverso.png`;
		}
