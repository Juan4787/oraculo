-- Fix create_reading to ensure unique cards per reading and random back per card
...
begin
	...
	values (
		...
		case when p_owner_type = 'person' then p_owner_person_id else null end,
		caller_id,
		p_spread_id,
		p_selected_deck_ids,
		seed
	...
	for i in 1..card_n loop
		...
		where sp.spread_id = p_spread_id
